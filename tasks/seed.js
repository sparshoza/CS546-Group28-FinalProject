...
*/
let test = undefined;
// let user1 = await users.create('rrmil', 'Robert', 'Miller', 'rmiller6@stevens.edu', 'testTest2@', ['CS555', 'CS546'], '2024');
let user2 = await users.create('Test', 'Test', 'Test', 'test@stevens.edu', 'testTest2@', ['CS555', 'CS546'], '2024');
let user3 = await users.create('Phill', 'Harmonic', 'phill@stevens.edu', 'test@2Test', ['CS546', 'CS135'], '2025');
